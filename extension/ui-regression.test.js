...
test('index includes deferred drawer trigger and overlay', () => {
  ...
  assert.match(html, /id="themeMenuTrigger"/);
  assert.match(html, /id="themeMenuPanel"/);
  assert.match(html, /id="themeBackgroundInput"/);
  assert.match(html, /id="themeTransparencyRange"/);
  assert.match(html, /id="themeTransparencyValue"/);
